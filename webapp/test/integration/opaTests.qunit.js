...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "gabc/vreport/vreport/test/integration/FirstJourney",
    "gabc/vreport/vreport/test/integration/VREPORTListJourney",
    "gabc/vreport/vreport/test/integration/VREPORTObjectPageJourney",
    "gabc/vreport/vreport/test/integration/VREPORTHObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
